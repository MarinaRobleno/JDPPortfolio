...
export default function Sidebar() {
  ...
  const scrollToSection = useCallback((targetElement: HTMLElement) => {
    ...
    const offset = 40; // Adjust this value to control how far from the top the section will be
    ...
    const animateScroll = (currentTime: number) => {
      ...
      // Scroll to target position minus the offset
      window.scrollTo(0, start + (targetPosition - start - offset) * easeInOutCubic);
